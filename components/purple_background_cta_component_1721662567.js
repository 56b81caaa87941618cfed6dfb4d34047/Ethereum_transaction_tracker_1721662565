...
Vue.component("purple_background_cta_component_1721662567", {
    template: `
        ...
        <div id="section-container" class="max-w-6xl mx-auto px-4 sm:px-6 bg-white">
            <div id="content-container" class="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
                ...
                <div id="content" class="max-w-3xl mx-auto text-center">
                    <div id="content-subtitle" class="flex"><div id="content-subtitle-text" class="flex-1 font-medium bg-clip-text pb-3 text-transparent bg-gradient-to-r from-purple-500 to-purple-200">Gain a Competitive Edge with Timely Transaction Insights</div></div>
                    ...
                    <div class="flex" id="content-body-container"><p id="content-body" class="flex-1 text-lg mb-8 text-slate-400">Stay ahead of the curve by monitoring the latest transactions on the Ethereum blockchain. Our app provides real-time alerts and insights to help you capitalize on emerging opportunities.</p></div>
